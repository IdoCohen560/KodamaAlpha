...
describe("generateBones", () => {
  ...
  // Golden snapshots updated for 25 species (original 18 + 7 new: fox, bat, panda, phoenix, wolf, slime, crystal)
  test("golden snapshot: 'golden-user-alpha' (common rabbit)", () => {
  ...
  test("golden snapshot: 'golden-user-beta' (common phoenix)", () => {
  ...
  test("golden snapshot: 'legendary-seed-1' (uncommon rabbit)", () => {
